...
`_set_precision`. Folding it in here would mean editing a file whose output is
already committed under data/raw/llm_smoke/, so the duplication is deliberate
for now and should be resolved when that file is next touched for another
reason.
"""
